...
export default class WebcamDraggable extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (prevUserLength !== userLength) {
      WebcamDraggable.waitFor(
        () => WebcamDraggable.getVideoCountBySelector() === userLength,
        this.updateWebcamPositionByResize,
      );
    }
  }
  ...
  setInitialReferencePoint() {
    ...
    const webcamBySelector = WebcamDraggable.getWebcamGridBySelector();
  ...
  videoMounted() {
    this.setResetPosition(true);
    WebcamDraggable.waitFor(this.setInitialReferencePoint, this.setLastWebcamPosition);
  ...
  handleWebcamDragStart() {
    ...
    if (!floatingOverlay && dropOnTop) WebcamDraggable.getOverlayBySelector().style.top = 0;
